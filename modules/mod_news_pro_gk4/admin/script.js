...
window.addEvent("domready",function(){
	getUpdates();
	//
	var data_sources = [document.id('jform_params_com_categories'), document.id('jform_params_com_articles'), document.id('jform_params_k2_categories'), document.id('jform_params_k2_articles'), document.id('jform_params_k2_tags'), document.id('jform_params_redshop_categories'), document.id('jform_params_redshop_products'), document.id('jform_params_vm_categories'),, document.id('jform_params_vm_products'), document.id('jform_paramsads_profiles') ];
	//
...
function getUpdates() {
	...
	var update_url = 'https://www.gavick.com/component/gk2_update/?task=json&tmpl=json&query=product&product=mod_news_pro_gk4_j16';
