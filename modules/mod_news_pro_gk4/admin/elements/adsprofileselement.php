...
class JFormFieldAdsProfilesElement extends JFormFieldList {
	protected $type = 'AdsProfilesElement'; //the form field type
    var $options = array();
    protected function getInput() {
		...
		// Create a regular list.
		    ...
		    if($options[0]!=''){
               ...
               return '<select id="paramsads_profiles" style="display:none"></select><strong style="line-height: 2.6em">Ads profiles not available.</strong>';
            }
		}
    ...
    protected function getOptions() {
        ...
        $db = JFactory::getDBO();
        // generating query
		$db->setQuery("SELECT * FROM #__profile WHERE published = 1  ORDER BY ordering ASC");
 		// getting results
