...
<?php 
$doc->addScript($this->baseurl.'/media/k2/assets/js/jquery.masonry.min.js', 'text/javascript');
$doc->addScript($this->baseurl.'/media/k2/assets/js/jquery.infinitscroll.min.js', 'text/javascript');
$doc->addScript($this->baseurl.'/media/k2/assets/js/jquery.galleriffic.js', 'text/javascript');
$doc->addScript($this->baseurl.'/media/k2/assets/js/jquery.opacityrollover.js', 'text/javascript');
$doc->addScript($this->baseurl.'/media/k2/assets/js/jquery.history.js', 'text/javascript');
$doc->addScript($this->baseurl.'/media/k2/assets/js/jush.js', 'text/javascript');
$doc->addScript($this->baseurl.'/media/k2/assets/js/jquery.fineuploader-3.3.0.min.js');
$doc->addScript($this->baseurl.'/media/k2/assets/js/iframe.xss.response-3.3.0.js');

$doc->addStyleSheet($this->baseurl.'/media/k2/assets/css/fineuploader-3.3.0.css');

$doc->addStyleSheet($this->baseurl.'/media/k2/assets/css/masonry.css');
?>
<script type="text/javascript">
  $(function(){
