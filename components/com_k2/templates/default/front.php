		...
		<div id="k2Frontend">
			...
			<div id="k2FrontendEditToolbar">
				<h2 class="header icon-48-k2">
					<?php echo (JRequest::getInt('cid')) ? JText::_('K2_EDIT_JEWELERY') : JText::_('K2_ADD_JEWELERY'); ?>
				</h2>
			</div>
			<div class="clr"></div>
			<hr class="sep" />
					...
					<tr>
						<td>
							...
							<div class="simpleTabs" id="k2Tabs">
								...
								<!-- Tab content -->
								<h2><?php echo JText::_('K2_CONTENT'); ?></h2>
								<div class="">
								...
								<?php endif; ?>
								<?php if ($this->params->get('showExtraFieldsTab')): ?>
								<?php echo JText::_('K2_EXTRA_FIELDS'); ?>
								<!-- Tab extra fields -->
								<div class="">
